...
export default class FinPage extends Component {
  constructor(props){
    super(props);
    this.state = {
      finPageApi:'https://api.readhub.cn/blockchain',
      fitForIPhoneX:false,
      dataSource:[],
  ...
  componenetDidUpdate(){
    console.log('FinPage componenetDidUpdate')
    this.updateContent();
  }
  componentDidMount(){
    console.log('FinPage componentDidMount')
    this.updateContent();
  }
  renderItem(){
